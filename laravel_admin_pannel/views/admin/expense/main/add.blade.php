      ...
      <div class="card">
          <div class="card-header card_header">
              <div class="row">
                ...
                <div class="col-md-4 card_button_part">
                  <a class="btn btn-md btn-dark" href="{{url('dashboard/expense')}}"><i class="mdi mdi-reorder-horizontal me-1"></i> <span>All Expense</span> </a>
                </div>
              </div>
          </div>
          <div class="card-body card_body">
            ...
            <div class="row mb-3 {{ $errors->has('category') ? ' has-error' : '' }}">
                ...
                <div class="col-7">
                    @php
                      $allCate=App\Models\ExpenseeCategoryy::where('expcate_status',1)->orderBy('expcate_name','ASC')->get();
                    @endphp
