                            ...
                            <div class="card">
                              <div class="card-header">
                                  <div class="row">
                                      ...
                                      <div class="col-md-4 text-right">
                                          <a class="btn btn-sm btn-dark card_top_btn" href="add-services.php"><i class="fa fa-plus-circle"></i> add Service</a>
                                      </div>
                              ...
                              <div class="card-body">
                                  <table class="table table-bordered table-striped table-hover custom_table">
                                    ...
                                    <?php
                                        $i=1;
                                      $sel="SELECT * FROM cs_services NATURAL JOIN blog_table ORDER BY id ASC";
                                      ...
                                      <tr>
                                        ...
                                        <td><?=  substr($data['service_details'],0,20); ?></td>
