<?php require_once('functions/manage.php');
            ...
            <div class="carousel-testimony owl-carousel">
              <div class="item">
                <div class="testimony-wrap d-flex">
                  <div class="user-img mr-4" style="background-image:url(images/xteacher-1.jpg.pagespeed.ic.AyWvtajk8X.jpg)"></div>
                  <div class="text ml-2">
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  <div class="user-img mr-4" style="background-image:url(images/xteacher-2.jpg.pagespeed.ic.RFUpMj6Lab.jpg)"></div>
                  <div class="text ml-2">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  <div class="user-img mr-4" style="background-image:url(images/xteacher-3.jpg.pagespeed.ic.po_-LXQR-Y.jpg)"></div>
                  <div class="text ml-2">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  <div class="user-img mr-4" style="background-image:url(images/xteacher-4.jpg.pagespeed.ic.lo-cdHm6M8.jpg)"></div>
                  <div class="text ml-2">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
